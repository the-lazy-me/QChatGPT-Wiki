...
# 
  ...
  - header: 致谢
    ...
    highlights:
      ...
      #   icon: home
      #   details: 为本项目开发多种插件
      #   link: https://github.com/dominoar

      # - title: ljcduo
      #   icon: home
      #   details: 整合包发行
      #   link: https://github.com/qq255204159

      # - title: 万神的星空
      #   icon: home
      #   details: GPT-4 API内测账号提供
      #   link: https://github.com/ljcduo

      # - title: 所有贡献者和其他为本项目提供支持的朋友们
      #   icon: home
      #   details: 他们为本项目的进一步发展提供了不同程度的支持

  # - header: 赞赏
  #   description: 请作者喝一杯咖啡
